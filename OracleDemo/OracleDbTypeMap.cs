    ...
    class OracleDbTypeMap
    {
        ...
        public static Type MapCommonType(string dbtype, int precision, int scale)
        {
            ...
            switch (dbtype)
            {
                ...
                //case "timestamp with local time zone": commonType = typeof(DateTime); break;
                //case "timestamp with time zone": commonType = typeof(DateTime); break;

                //case "blob": commonType = typeof(byte[]); break;
                //case "long raw": commonType = typeof(byte[]); break;
                //case "raw": commonType = typeof(byte[]); break;
                //case "bfile": commonType = typeof(byte[]); break;
